...
class Profile(models.Model):
    ...
    AREA_CHOICES = [
        ...
        ('West Gate', 'West Gate'),
        ('Stateline', 'Stateline'),
        ('Akindeko Hostel', 'Akindeko Hostel'),
        ('Jibowu Hostel Area', 'Jibowu Hostel Area'),
        ('New Hostel', 'New Hostel'),
    ...
    department = models.CharField('Department', max_length=100, null='False')
    ...
    address = models.CharField('Address', max_length=50, null='False')
    phone_number = models.CharField('Phone Number', max_length=25, null='False')
    birthday = models.DateField('Birthday', auto_now=False, auto_now_add=False, null='False')
